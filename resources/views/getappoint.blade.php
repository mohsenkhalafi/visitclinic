        ...
        <div class="inner-subheader">
            ...
            <div class="subheader2">
                <ul>
                    ...
                    <li> <?php echo  session()->get('fname')." ".session()->get('lname')." "; ?>خوش آمدید</li>
...
<h3 align="center">لیست پزشکان</h3>
<table class='responstable' id="tbl" >
    <tr>
        ...
        <th class='text-left'  align="center">وضعیت</th>
    ...
    @foreach($show as $timelist)
        ...
        <td class='text-left'>{{$timelist->expert}}</td>
         ...
         <td class='text-left'>{{$timelist->fhour}}-{{$timelist->thour}}</td>
            <td class='text-left'>{{$timelist->date}}</td>
            <td class='text-left'>{{$timelist->status}}</td>
            <td class='text-left'><a href="timelists/id={{$timelist->code}}/_xd={{$timelist->id}}">ثبت</a></td>
        </tr>
        @endforeach
</table>
