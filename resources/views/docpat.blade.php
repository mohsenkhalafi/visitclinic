            ...
            <div class="inner-subheader">
                ...
                <div class="subheader2">
                    <ul>
                        ...
                        <li> <?php $t=session()->get('state');  if($t=='yes'){echo session()->get('fname')." ".session()->get('lname').' '.'<a href="logout"> <li>خروج</li></a>';} else{ echo '<a href="welcome"> <li>ورود</li></a>'.'مهمان '."";} ?>خوش آمدید</li>
...
<br>
<div align="center">
    <?php  $msg=session()->get('dcmsg'); echo $msg; ?>
    <br>
    <div class="img-thumbnail" align="center">
        {!! Form::Open(array('action' => "UserController@dsave")) !!}
        {!! Form::Label('code','کد ارسالی') !!}
